...
?>
        ...
        <div class="jumbotron">
          ...
          <p>A brunch of beautiful images that I didn't take(except for the first one!)</p>
        </div>
                    ...
                    <?php foreach ($photos as $photo): ?>
                            <div class="col-xs-6 col-md-3"> 
                                <a class="thumbnail" href="photo.php?id=<?php echo $photo->id; ?>">
                                    <img class="home_page_photo img-resposive" src="admin/<?php echo $photo->picture_path(); ?>" alt="">
                                </a>
                            </div>
                    <?php endforeach; ?>
                </div>
